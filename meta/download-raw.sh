...
declare -a ARETFACTS=( "alertmanager" "boundary" "consul" "fake-service" "fleet" "graalvm" "gitlab-runner-buildah" "kuma-cp" "loki" "mimir" "minio" "minio-console" "nexus" "terraform" )
