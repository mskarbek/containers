...
dnf_cache
dnf_install "--enablerepo=codeready-builder-for-rhel-9-x86_64-rpms python3 python3-pip python3-setuptools python3-wheel python3-pip-wheel python3-setuptools-wheel"
dnf_install "--enablerepo=codeready-builder-for-rhel-9-x86_64-rpms ansible-core git-core rsync python3-requests python3-certifi python3-idna python3-charset-normalizer python3-wcwidth python3-pbr python3-attrs python3-urllib3 python3-prettytable"
dnf_clean_cache
dnf_clean
...
commit_container rundeck-runner ${IMAGE_TAG}
